...
# Portic State Machine API

> Api per publicar events d'alarmes i per a consultar-los

## notify - notify new event to state machine

POST localhost:3000/api/v1/sm/notify
...
## check state machine
POST localhost:3000/api/v1/sm/check
